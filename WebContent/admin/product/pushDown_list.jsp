...
<HTML>
	...
	<body>
		<br>
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/product/pushDown_list.jsp" method="post">
							...
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<tr
									...
									<td width="7%" align="center">
										...
										<c:forEach items="${pflag}" var="p" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/AdminProductServlet?method=add&pid=${p.pid}">
