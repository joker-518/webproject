...
<%@ page import="cn.itcast.store.domain.User"%>
...
<body>
	<form id="frm1" name="Form1"
		action="${pageContext.request.contextPath}/AdminUserServlet?method=updateUser"
		method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					真实姓名：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="name" value="${user.name }" id="userAction_save_do_logonName"
					class="bg" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					邮箱：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
			...
			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					电话：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text"
					name="phone" value="${user.telephone }"
					id="userAction_save_do_logonName" class="bg" /></td>
			</tr>
