...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010402','0104','已下架商品管理','${pageContext.request.contextPath}/AdminProductServlet?method=findPflag','','mainFrame');
		...
		d.add('010602','0106','黄金用户','','','mainFrame');
		d.add('010603','0106','普通用户','${pageContext.request.contextPath}/AdminUserServlet?method=findUsers','','mainFrame');
