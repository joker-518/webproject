...
<html>
	...
	<head>
		...
		<title>viper网络商城</title>
		<link rel="shortcut icon" href="img/ad/favicon.ico" type="image/x-icon">
		...
		<div class="container-fluid">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="${pageContext.request.contextPath}/img/admin/1.jpg">
							<div class="carousel-caption">

							</div>
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/img/admin/2.jpg">
							<div class="carousel-caption">

							</div>
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/img/admin/3.jpg">
							<div class="carousel-caption">
			...
			<div class="container-fluid">
				...
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="products/hao/big011.jpg" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="product_info.htm">
							<img src="products/hao/middle011.jpg" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
