		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					<a href="/store_v5/ProductServlet?method=findProductsByCidWithPage&num=1&cid=${product.cid}">返回&nbsp;&nbsp;&lt;</a>
				  ...
				  <form id="myForm" method="post" action="${pageContext.request.contextPath}/CartServlet?method=addCartItemToCart">
					...
					<div class="col-md-6">
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							<div style="border-bottom: 1px solid #faeac7;margin-top:20px;padding-left: 10px;">默认颜色
				...
				<div style="width:950px;margin:0 auto;">
					...
					<img  src="img/1920-720-neo-may-dailing.jpg" style="width:930px;">
				    </div>
				    <div style="width:930px;">
					<img  src="img/kv-pc-summerattack-ning.jpg" style="width:930px;">
				    </div>
				    <div >
					<img  src="">
				    </div>
